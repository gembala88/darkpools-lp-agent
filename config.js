...
if (u.fallbackModel)    process.env.LLM_FALLBACK_MODEL ||= u.fallbackModel;
...
export const SCREENING_PROFILES = {
  scalping: {
    label: "Scalping",
    description: "Quick fee harvesting on active pools (30m timeframe, slightly selective)",
    minMcap: 20_000,
    minHolders: 100,
    minVolume: 500,
    minTvl: 3_000,
  ...
  compounding: {
    label: "Compounding",
    description: "Longer hold on quality pools (24h timeframe, moderate quality bar)",
    minMcap: 100_000,
    minHolders: 300,
    minVolume: 2_000,
    minTvl: 10_000,
...
export const config = {
  ...
  management: {
    ...
    dryRunVirtualBalance:  u.dryRunVirtualBalance  ?? 2.0, // simulated SOL balance in DRY RUN
  },
