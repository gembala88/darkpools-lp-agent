 ...
 */
import { config, SCREENING_PROFILES, activeProfile, getProfileDisplayLabel, isProfileActive } from "./config.js";
...
ACTIVE SCREENING PROFILE: ${getProfileDisplayLabel ? getProfileDisplayLabel() : "Manual"}
  ...
  — Description: ${isProfileActive && isProfileActive() ? (SCREENING_PROFILES[activeProfile]?.description || "N/A") : "Using manual config thresholds from user-config.json"}
